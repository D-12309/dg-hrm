...
class HrmExpenseController extends Controller
{
    ...
    {
        $data['title'] = _trans('common.Expense list');
    ...
    public function store(Request $request)
    {
        ...
        $request['income_expense_category_id']=$request->expense_category_id;
    ...
    public function approveOrReject(HrmExpense $expense, $status): \Illuminate\Http\RedirectResponse
    {
        ...
        if ($updateStatus) {
            ...
            Toastr::error(_trans('response.Operation did not successful'), 'Error');
            return redirect()->back();
        }
