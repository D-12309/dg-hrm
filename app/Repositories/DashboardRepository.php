        ...
        try {
            ...
            if (in_array('appointments', $screen_data)) {
                $data['today'][] = [
                    ...
                    'title' => _trans('appointment.Appointments'),
                    'slug' => 'appointment',
            ...
            if (in_array('support', $screen_data)) {
                $data['today'][] = [
                    ...
                    'title' => _trans('support.Support Tickets'),
                    'slug' => 'support_ticket',
            ...
            $data['current_month'][] = [
                ...
                'title' => _trans('attendance.Late In'),
                'slug' => 'late_in',
            ...
            if (in_array('leave', $screen_data)) {
                $data['current_month'][] = [
                    ...
                    'title' => _trans('attendance.Leaves'),
                    'slug' => 'leave',
            ...
            if (in_array('daily-leave', $screen_data)) {
                $data['current_month'][] = [
                    ...
                    'title' => _trans('attendance.Early Leaves'),
                    'slug' => 'early_leave',
            ...
            $data['current_month'][] = [
                ...
                'title' => _trans('attendance.Absents'),
                'slug' => 'absent',
    ...
    public function getSuperadminDashboardStatistic($request)
    {
        try {
            ...
            $data['current_month'][] = [
                ...
                'title' => _trans('common.Total Company'),
                'slug' => 'total_company',
    ...
    public function getCompanyDashboardStatistics($request)
    {
        try {
            ...
            $data['today'][] = [
             ...
             $data['current_month'][] = [
                 'image' => asset($this->getStatisticsImage('visit')),
                 'title' => _trans('attendance.Visits'),
                 'slug' => 'visits',
                 'number' => Visit::where('date', 'LIKE', '%' . $year . '-' . $month . '%')
                     ->where('user_id', auth()->user()->id)
                     ->count(),
