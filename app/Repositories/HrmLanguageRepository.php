...
class HrmLanguageRepository extends BaseRepository
{
    ...
    function store($request){
        try {
            ...
            $hrm_language=new $this->model();
            $hrm_language->language_id=$request->language_id;
            $hrm_language->country_code=$request->country;
            $hrm_language->country_name=$country->name;
            $hrm_language->save();
    ...
    function getHrmLanguageInfo($language_id){
        try {
            $hrm_language= $this->model->where('language_id',$language_id)->first();
            return $hrm_language;
        } catch (\Throwable $th) {
            return $th->getMessage();
        }
    ...
    function setCountry($request){
        try {
            $hrm_language= $this->model->where('language_id',$request->id)->first();
            $hrm_language->country_name=$request->country_name;
            $hrm_language->country_code=$request->country_code;
            $hrm_language->save();
            return true;
        } catch (\Throwable $th) {
            return false;
