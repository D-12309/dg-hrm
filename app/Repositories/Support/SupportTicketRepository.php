...
class SupportTicketRepository
{
    ...
    public function suportDatatable($tickets)
    {
        ...
        ->addColumn('lastActivity', function ($data) {
            return @showDate($data->latestReplay->created_at);
        })
        ...
        ->rawColumns(array('date', 'code', 'employee_name', 'subject', 'employee_name','lastActivity', 'type', 'priority', 'action'))
        ->make(true);
    }
