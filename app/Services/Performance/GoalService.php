    ...
    function table($request)
    {
        ...
        return [
            'data' => $files->map(function ($data) {
                $action_button = '';
                if (hasPermission('performance_goal_update')) {
                    $action_button .= actionButton(_trans('common.Edit'), 'mainModalOpen(`' . route('performance.goal.edit', $data->id) . '`)', 'modal');
                }
                if (hasPermission('performance_goal_view')) {
                    $action_button .= actionButton(_trans('common.View'), 'mainModalOpen(`' . route('performance.goal.view', $data->id) . '`)', 'modal');
                }
