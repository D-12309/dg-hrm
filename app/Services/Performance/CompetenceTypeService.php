    ...
    function table($request)
    {
        ...
        return [
            'data' => $files->map(function ($data) {
                $action_button = '';
                if (hasPermission('performance_competence_type_update')) {
                ...
                if (hasPermission('performance_competence_type_delete')) {
                    $action_button .= actionButton('Delete', '__globalDelete(' . $data->id . ',`admin/performance/settings/competence-type/delete/`)', 'delete');
                }
