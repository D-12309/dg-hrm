...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'dashboard'], function () {
    ...
    Route::group(['prefix' => 'user'], function () {
        ...
        Route::get('edit/{user}',                   [UserController::class, 'edit'])->name('user.edit')->middleware('PermissionCheck:user_core_update');
    ...
    Route::group(['prefix' => 'announcement', 'middleware' => ['MaintenanceMode']], function () {
        Route::group(['prefix' => 'notice'], function () {
            ...
            Route::get('show/{id}', [NoticeController::class, 'showWeb'])->name('notice.show')->middleware('PermissionCheck:notice_update');
            ...
            Route::get('push-notification', [NoticeController::class, 'pushNotification'])->name('notice.pushNotification')->middleware('PermissionCheck:push_notification');
            Route::get('push-notification/history', [NoticeController::class, 'pushNotificationHistory'])->name('notice.pushNotificationHistory')->middleware('PermissionCheck:push_notification');
            Route::get('history-dataTable', [NoticeController::class, 'historyDataTable'])->name('notice.historyDataTable');
            Route::get('push-notification/history/{notice_id}', [NoticeController::class, 'pushNotificationDetails'])->name('notice.pushNotificationDetails')->middleware('PermissionCheck:push_notification');
            Route::post('push-notification', [NoticeController::class, 'sendPushNotification'])->name('notice.sendPushNotification')->middleware('PermissionCheck:push_notification');
        });
