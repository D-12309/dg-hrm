...
Route::group(['prefix' => 'admin/settings', 'middleware' => ['admin']], function () {
    ...
    Route::post('/send-test-email',               [SettingsController::class, 'sendTestEmail'])->name('sendTestEmail')->middleware('PermissionCheck:email_settings_update');
    ...
    Route::post('/ajax-set-country',      [LanguageSettingController::class, 'setCountry'])->name('language.setCountry');
    ...
    Route::group(['middleware'=>'SuperAdminMiddleware'], function () {
        ...
        Route::group(['prefix' => 'app-setting'], function () {
            ...
            Route::post('/app-screen-sortable',   [AppSettingsController::class, 'AppScreenSortable'])->name('AppScreenSortable');
        });
