...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'admin/award'], function () {
        ...
        Route::controller(AwardTypeController::class)->prefix('type')->group(function () {
            ...
            Route::get('create', 'create')->name('award_type.create')->middleware('PermissionCheck:award_type_store');
            Route::post('store', 'store')->name('award_type.store')->middleware('PermissionCheck:award_type_store');
            Route::get('edit/{id}', 'edit')->name('award_type.edit')->middleware('PermissionCheck:award_type_update');
