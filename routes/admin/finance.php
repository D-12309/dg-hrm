...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'hrm'], function () {
    ...
    Route::controller(DepositController::class)->prefix('deposit')->group(function () {
        ...
        Route::get('create', 'create')->name('hrm.deposits.create')->middleware('PermissionCheck:deposit_store');
        Route::post('store', 'store')->name('hrm.deposits.store')->middleware('PermissionCheck:deposit_store');
        Route::get('edit/{id}', 'edit')->name('hrm.deposits.edit')->middleware('PermissionCheck:deposit_update');
    ...
    Route::controller(ExpenseController::class)->prefix('expenses')->group(function () {
        ...
        Route::any('/report', 'index')->name('hrm.expenses.report')->middleware('PermissionCheck:expense_list');
