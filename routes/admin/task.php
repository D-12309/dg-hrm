...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'admin/task'], function () {
    ...
    Route::controller(TaskController::class)->group(function () {
        ...
        Route::get('create', 'create')->name('task.create')->middleware('PermissionCheck:task_store');
        Route::get('edit/{id}', 'edit')->name('task.edit')->middleware('PermissionCheck:task_update');
        ...
        Route::get('complete', 'complete')->name('task.complete');
          ...
          Route::controller(TaskDiscussionController::class)->prefix('discussion')->group(function () {
            ...
            Route::get('create', 'create')->name('task.discussion.create')->middleware('PermissionCheck:task_discussion_store');
            Route::post('store', 'store')->name('task.discussion.store')->middleware('PermissionCheck:task_discussion_store');
            Route::get('edit/{id}', 'edit')->name('task.discussion.edit')->middleware('PermissionCheck:task_discussion_update');
        ...
        Route::controller(TaskNoteController::class)->prefix('note')->group(function () {
            Route::get('create', 'create')->name('task.note.create')->middleware('PermissionCheck:task_notes_store');
            Route::post('store', 'store')->name('task.note.store')->middleware('PermissionCheck:task_notes_store');
            Route::get('edit', 'edit')->name('task.note.edit')->middleware('PermissionCheck:task_notes_update');
        ...
        Route::controller(TaskFileController::class)->prefix('file')->group(function () {
            Route::get('create', 'create')->name('task.file.create')->middleware('PermissionCheck:task_file_store');
            ...
            Route::get('edit', 'edit')->name('task.file.edit')->middleware('PermissionCheck:task_files_update');
