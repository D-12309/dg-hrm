...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'admin/client'], function () {
    ...
    Route::controller(ClientController::class)->group(function () {
        ...
        Route::get('create', 'create')->name('client.create')->middleware('PermissionCheck:client_store');
        Route::post('store', 'store')->name('client.store')->middleware('PermissionCheck:client_store');
        Route::get('edit/{id}', 'edit')->name('client.edit')->middleware('PermissionCheck:client_update');
