...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'admin/project'], function () {
    ...
    Route::controller(ProjectController::class)->group(function () {
        ...
        Route::get('create', 'create')->name('project.create')->middleware('PermissionCheck:project_store');
        Route::post('store', 'store')->name('project.store')->middleware('PermissionCheck:project_store');
        Route::get('edit/{id}', 'edit')->name('project.edit')->middleware('PermissionCheck:project_update');
        ...
        Route::controller(DiscussionController::class)->prefix('discussion')->group(function () {
            Route::get('/datatable/{id}', 'datatable')->name('project.discussion.datatable')->middleware('PermissionCheck:project_discussion_list');
            Route::get('create', 'create')->name('project.discussion.create')->middleware('PermissionCheck:project_discussion_store');
            Route::post('store', 'store')->name('project.discussion.store')->middleware('PermissionCheck:project_discussion_store');
            Route::get('edit/{id}', 'edit')->name('project.discussion.edit')->middleware('PermissionCheck:project_discussion_edit');
            Route::post('update/{id}', 'update')->name('project.discussion.update')->middleware('PermissionCheck:project_discussion_update');
            Route::get('delete/{id}', 'delete')->name('project.discussion.delete')->middleware('PermissionCheck:project_discussion_delete');
            Route::get('view/{id}/{data}', 'view')->name('project.discussion.view')->middleware('PermissionCheck:project_discussion_view');
        ...
        Route::controller(NoteController::class)->prefix('note')->group(function () {
            Route::get('create', 'create')->name('project.note.create')->middleware('PermissionCheck:project_notes_store');
            Route::post('store', 'store')->name('project.note.store')->middleware('PermissionCheck:project_notes_store');
            Route::get('edit', 'edit')->name('project.note.edit')->middleware('PermissionCheck:project_notes_update');
        ...
        Route::controller(FileController::class)->prefix('file')->group(function () {
            Route::get('create', 'create')->name('project.file.create')->middleware('PermissionCheck:project_file_store');
            ...
            Route::get('edit', 'edit')->name('project.file.edit')->middleware('PermissionCheck:project_files_update');
