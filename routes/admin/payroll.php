...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'hrm'], function () {
   // payroll commission route
   Route::controller(CommissionController::class)->prefix('payroll/item')->group(function () {
      Route::any('/', 'index')->name('hrm.payroll_items.index')->middleware('PermissionCheck:payroll_item_menu');
      Route::get('/datatable', 'datatable')->name('hrm.payroll_items.datatable')->middleware('PermissionCheck:payroll_item_menu');
      Route::get('create', 'create')->name('hrm.payroll_items.create')->middleware('PermissionCheck:payroll_item_menu');
      Route::post('store', 'store')->name('hrm.payroll_items.store')->middleware('PermissionCheck:payroll_item_menu');
   ...
   Route::controller(SalarySetUpController::class)->prefix('payroll')->group(function () {
      Route::any('setup', 'index')->name('hrm.payroll_setup.index')->middleware('PermissionCheck:list_payroll_setup');
      Route::get('setup/datatable', 'data')->name('hrm.payroll_setup.datatable')->middleware('PermissionCheck:list_payroll_setup');
      ...
      Route::get('get-item-list', 'item_list')->name('hrm.payroll_setup.item_list')->middleware('PermissionCheck:view_payroll_set');
