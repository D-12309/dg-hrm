...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'admin/performance'], function () {
    ...
    Route::controller(IndicatorController::class)->prefix('indicator')->group(function () {
        ...
        Route::get('create', 'create')->name('performance.indicator.create')->middleware('PermissionCheck:performance_indicator_store');
    ...
    Route::controller(AppraisalController::class)->prefix('appraisal')->group(function () {
        ...
        Route::get('create', 'create')->name('performance.appraisal.create')->middleware('PermissionCheck:performance_appraisal_store');
        Route::post('store', 'store')->name('performance.appraisal.store')->middleware('PermissionCheck:performance_appraisal_store');
        Route::get('edit/{id}', 'edit')->name('performance.appraisal.edit')->middleware('PermissionCheck:performance_appraisal_update');
    ...
    Route::controller(GoalController::class)->prefix('goal')->group(function () {
        ...
        Route::get('create', 'create')->name('performance.goal.create')->middleware('PermissionCheck:performance_goal_store');
        Route::post('store', 'store')->name('performance.goal.store')->middleware('PermissionCheck:performance_goal_store');
        Route::get('edit/{id}', 'edit')->name('performance.goal.edit')->middleware('PermissionCheck:performance_goal_update');
    ...
    Route::prefix('settings')->group(function () {
         ...
         Route::controller(CompetenceTypeController::class)->prefix('competence-type')->group(function () {
            ...
            Route::get('create', 'create')->name('performance.competence.type.create')->middleware('PermissionCheck:performance_competence_type_store');
            ...
            Route::get('edit/{id}', 'edit')->name('performance.competence.type.edit')->middleware('PermissionCheck:performance_competence_type_update');
        ...
        Route::controller(CompetenceController::class)->prefix('competence')->group(function () {
            ...
            Route::get('create', 'create')->name('performance.competence.create')->middleware('PermissionCheck:performance_competence_store');
            Route::post('store', 'store')->name('performance.competence.store')->middleware('PermissionCheck:performance_competence_store');
            Route::get('edit/{id}', 'edit')->name('performance.competence.edit')->middleware('PermissionCheck:performance_competence_update');
        ...
        Route::controller(GoalTypeController::class)->prefix('goal-type')->group(function () {
            ...
            Route::get('create', 'create')->name('performance.goal_type.create')->middleware('PermissionCheck:performance_goal_type_store');
            Route::post('store', 'store')->name('performance.goal_type.store')->middleware('PermissionCheck:performance_goal_type_store');
            Route::get('edit/{id}', 'edit')->name('performance.goal_type.edit')->middleware('PermissionCheck:performance_goal_type_update');
