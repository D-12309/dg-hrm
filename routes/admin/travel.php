...
Route::group(['middleware' => ['admin', 'TimeZone'], 'prefix' => 'admin/travel'], function () {
        ...
        Route::controller(TravelTypeController::class)->prefix('type')->group(function () {
            ...
            Route::get('create', 'create')->name('travel_type.create')->middleware('PermissionCheck:travel_type_store');
            Route::post('store', 'store')->name('travel_type.store')->middleware('PermissionCheck:travel_type_store');
            Route::get('edit/{id}', 'edit')->name('travel_type.edit')->middleware('PermissionCheck:travel_type_update');
