$(document).ready(function () {
    ...
    //ip config table end
    //ip config table start
    function ipUserConfigDatatable() {
        let data = [];
        let url = $("#ip_user_list_data_url").val();
        data["url"] = url;
        ...
        data["column"] = [
            ...
            {data: "designation", name: "designation"},
            {data: "department", name: "department"},
            {data: "ip_bind", name: "ip_bind"},
            {data: "ip_address", name: "ip_address"},
            {data: "action", name: "action", orderable: true, searchable: true},
        ];

        data["order"] = [[1, "desc"]];
        data["table_id"] = "ip_user_table";
        ajaxTable(data);
    }

    $(".ip_user_table").length > 0 && ipUserConfigDatatable();
    // $(".ip_user_table").on("click", () => ipUserConfigDatatable());
    //ip config table end
    ...
    function visitDatatable() {
        ...
        var __user_id = $("#company_employee").val();
    ...
    //push notification history table start
    
    function pushNotificationHistory() {
        let data = [];
        let url = $("#push_notification_data_url").val();
        data["url"] = url;
        data["value"] = {
            _token: _token,
        };
        ...
        data["order"] = [[1, "desc"]];
        data["table_id"] = "push_notification_table";
        ajaxTable(data);
    }

    $(".push_notification_table").length > 0 && pushNotificationHistory();
    //push notification history table start
