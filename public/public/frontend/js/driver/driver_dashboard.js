       ...
       if (data['summary'].length > 0) {
        ...
        data['summary'].forEach(stats => {
            ...
            if( parseInt(stats.agreement) > parseInt(stats.distance)){
                img = '<img src="'+asset('public/backend/img/dashboard/partially-success.svg')+'" alt="">';
            }else{
                img = '<img src="'+asset('public/backend/img/dashboard/success.svg')+'" alt="">';
            }
            stats.agreement > 0 ? content += `<tr class="dashboard-summery-tr">
                            <td class="title">${ stats.month }</td>
                            <td class="summary-distance-td">
                                <span>
                                    <img src="${ asset('public/backend/img/dashboard/target-achieved.svg') }"
                                        alt="">
                                ...
                                <br>
                                <span>
                                    <img src="${ asset('public/backend/img/dashboard/target.svg') }"
                                        alt="">
