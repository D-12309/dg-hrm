...
*/
var dt_showing=$('#dt_showing').val();
var dt_show=$('#dt_show').val();
var dt_to=$('#dt_to').val();
var dt_of=$('#dt_of').val();
var dt_entries=$('#dt_entries').val();
var dt_search=$('#dt_search').val();
var dt_not_found=$('#dt_not_found').val();
var dt_total_entries=$('#dt_total_entries').val();
var $jscomp = $jscomp || {};
$jscomp.scope = {};
...
(function (f) {
    ...
    q.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: dt_showing+" _START_ "+dt_to+" _END_ "+dt_of+" _TOTAL_ "+dt_entries,
            sInfoEmpty: dt_showing+" 0 "+dt_to+" 0 "+dt_of+" 0 "+dt_entries,
            sInfoFiltered: "( "+dt_total_entries+" _MAX_)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: dt_show+" _MENU_ "+dt_entries,
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: dt_search+":",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: dt_not_found,
        },
