...
function car3d(elid){
    (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
        1: [function (require, module, exports) {
            ...
            Rotation.prototype.show = function (n, cl) {
                c_count = c_count +1;
                ...
                switch(this.current){
                    case 0:
                        ...
                        $('.coverage-level-btn.side').addClass('active');
                    ...
                    case 2:
                        $('.coverage-level-btn').removeClass('active');
                        $('.coverage-level-btn.front').addClass('active');
                    ...
                    case 6:
                        $('.coverage-level-btn').removeClass('active');
                        $('.coverage-level-btn.back').addClass('active');
                    ...
                    default:
                        $('.coverage-level-btn').removeClass('active');
                        $('.coverage-level-btn.full').addClass('active');
            ...
            $(".coverage-level-btn").on("click", function(){
                ...
                let children = $('#fullCarRotation').children();
                let carType = $(this).attr("adTyperCar");
                switch(carType){
                    case "full":
                        Rotation.prototype.show(1, children);
                        break;
                    case "side":
                        Rotation.prototype.show(0, children);

                        break;
                    case "front":
                        Rotation.prototype.show(2, children);
                        break;
                    case "back":
                        Rotation.prototype.show(6, children);
                        break;
                }
            })
