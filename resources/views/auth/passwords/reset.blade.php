        ...
        <div class=" cus-card">
            <div class="card-body login-card-body">
                ...
                <form action="" method="post" id="login" class="password_reset_form">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" placeholder="{{ _trans('auth.password') }}" class="form-control" placeholder="Password">
                    </div>
                    <p class="text-danger __password small-text"></p>
                    <div class="input-group mb-3">
                        <input type="password" name="password_confirmation" class="form-control" placeholder="{{ _trans('auth.Confirm password') }}">
                    </div>
