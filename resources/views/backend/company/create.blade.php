                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="business_type" class="form-control"
                                                placeholder="Business Type" value="{{ old('business_type') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="country_id" class="form-control select2" id="_country_id" required style="width: 100%"></select>
