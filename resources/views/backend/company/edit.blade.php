                                ...
                                <div class="row mb-10">
                                    <div class="col-md-12">
                                        <div class="float-right mb-3  text-right">
                                            <a href="{{ route('company.index') }}"  class="btn btn-primary "> <i class="fa fa-arrow-left"></i> Back</a>
                                        </div>
                                    </div><!-- /.col -->
                                </div><!-- /.row -->
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_name" class="form-control"
                                                placeholder="Company Name" value="{{ $data['show']->company_name }}"
                                                required>
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_employee" class="form-control"
                                                placeholder="Total Employee" value="{{ $data['show']->total_employee }}"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="business_type" class="form-control"
                                                placeholder="Business Type" value="{{ $data['show']->business_type }}"
                                                required>
