    ...
    <section class="content p-0">
        <div class="container-fluid table-filter-container border-radius-5 p-imp-30">
            ...
            <div class="row align-items-center mb-15">
                ...
                <div class="col-sm-6 col-12">
                    ...
                    <a href="{{ route('company.settings.locationCreate') }}"
                        class="btn btn-primary float-right float-left-sm-device"> <i class="fa fa-plus-square"></i> {{
            ...
            <div class="row dataTable-btButtons">
                <div class="col-lg-12">
                    <table id="table"
                        class="table card-table table-vcenter datatable mb-0 w-100 location_bind_list_datatable">
                        <thead>
                            <tr>
