                                        ...
                                        <div class="content py-primary">
                                            <div props="[object Object]" id="General-0">
                                                <form action="{{ route('company.settings.update') }}" method="post"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div>
                                                                           <input type="number" max="24" class="form-control" name="max_work_hours" value="{{ @$data['configs']['max_work_hours'] ? @$data['configs']['max_work_hours'] : 16 }}"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row"><label
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div>
                                                                            <input type="text" class="form-control" name="firebase" value=""
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group row"><label
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div>
                                                                            <input type="text" class="form-control" name="fcm_topic" value=""
                                                    ...
                                                    <div>
                                                        @if(hasPermission('company_setup_configuration_update'))
