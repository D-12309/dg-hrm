                                        ...
                                        <div class="content py-primary">
                                            <div props="[object Object]" id="General-0">
                                                <form action="{{ route('company.settings.update') }}" method="post"
                                                    ...
                                                    <fieldset class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group row"><label
                                                                        class="col-sm-3 col-form-label">
                                                                        {{ _trans('settings.User wise Permission') }}
                                                                    </label>
                                                                    <div class="col-sm-9">
                                                                        <div>
                                                                            <div class="radio-button-group">
                                                                                <div data-toggle="buttons"
                                                                                    ...
                                                                                    <label class="btn border"><input
                                                                                            type="radio"
                                                                                            name="user_wise_permission"
                                                                                            id="user_wise_permission-0"
                                                                                            value="1" {{
                                                                                            @$data['configs']['user_wise_permission']==='1'
                                                                                            ? 'checked' : '' }}>
                                                                                        <span>
                                                                                            {{ _trans('settings.Enable')
                                                                                            }}</span></label><label
                                                                                        class="btn border"><input
                                                                                            type="radio"
                                                                                            name="user_wise_permission"
                                                                                            id="user_wise_permission-1"
                                                                                            value="0" {{
                                                                                            @$data['configs']['user_wise_permission']==='0'
                                                                                            ? 'checked' : '' }}>
                                                                                        <span>
                                                                                            {{
                                                                                            _trans('settings.Disable')
                                                    ...
                                                    <div>
                                                        @if (hasPermission('company_setup_activation_update') || hasPermission('company_settings_read'))
