                           ...
                           <div class="row">
                                       ...
                                       <div class="card">
                                           <div class="card-body pt-2 readmores px-6 mx-1">
                                               ...
                                               <div class="d-block">
                                                   ...
                                                   @endphp
                                                   <small class="fs-13"><i class="feather feather-clock text-muted me-1"></i>{{ _trans('support.Last
                               ...
                               <div class="col-md-12">
                                   <div class="form-group">
                                       <label for="" class="cus-label">{{ _trans('common.Type') }}</label>
                                       <select name="type_id" class="form-control select2" required="required">
                                           ...
                                           <option value="12" {{ $data['show']->type_id == 12 ? 'selected': '' }}>{{ _trans('support.Open') }}
                                           </option>
                                           <option value="13" {{ $data['show']->type_id == 13 ? 'selected': '' }}>{{ _trans('support.Close') }}
                                           </option>
                                       </select>
                               ...
                               <div class="col-md-12">
                                   <div class="form-group">
                                       <label for="description" class="cus-label">{{ _trans('support.Message') }}</label>
                               ...
                               <div class="col-md-12">
                                <div class="text-center">
                                    <button class="btn btn-primary">{{ _trans('support.Reply') }}</button>
                                </div>
