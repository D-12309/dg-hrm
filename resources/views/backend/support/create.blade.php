                ...
                <form action="{{ route('supportTicket.store') }}"
                    ...
                    <div class="row">
                        <div class="col-md-2"></div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="type_id" class="form-control select2" required="required">
                                        ...
                                        <option value="12">{{ _trans('support.Open') }}</option>
                                        <option value="13">{{ _trans('support.Close') }}</option>
                                    </select>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="priority_id" class="form-control select2" required="required">
                                        <option value="" disabled selected>{{ _trans('common.Choose One') }}</option>
                                        <option value="14">{{ _trans('support.High') }}</option>
                                        <option value="15">{{ _trans('support.Medium') }}</option>
                                        <option value="16">{{ _trans('support.Low') }}</option>
                                    </select>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="subject" class="cus-label">{{ _trans('support.Subject') }}</label>
