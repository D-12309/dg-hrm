                                ...
                                <div class="card card-with-shadow border-0">
                                    <div class="tab-content px-primary">
                                        ...
                                        <div id="Email" class="tab-pane fade {{ $email_setup ? 'active':'' }}">
                                            ...
                                            <fieldset>
                                                <legend>{{ _trans('settings.Test Email Setup') }}</legend>
                                                <div class="content py-primary">
                                                    <form action="{{ route('sendTestEmail') }}" method="post">
                                                        ...
                                                        <div class="col-lg-7 col-xl-7">
                                                            <div>
                                                                <input type="text" name="receiver_email" id="emailSettingsFromName" required="required"
                                                                    placeholder="{{ _trans('settings.Receiver Email') }}" autocomplete="off" value="" class="form-control ">
                                                                <!---->
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-8 col-xl-8">
                                                            <div class="form-group">
                                                                <select name="FILESYSTEM_DRIVER" id="select_storage"
                                                                    ...
                                                                    <option value="local" {{ env('FILESYSTEM_DRIVER')=='local'?'selected':'' }}>Local</option>
                                                                    <option value="s3" {{ env('FILESYSTEM_DRIVER')=='s3'?'selected':'' }}>S3</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @if (env('APP_STYLE') == 'Demo')
                                                        
                                                        <div class="s3_section {{ env('FILESYSTEM_DRIVER') == 'local' ?'d-none':'' }}">
                                                            <div class="form-group row align-items-center"><label
                                                                    for="emailSettingsFromName"
                                                                    class="col-lg-3 col-xl-3 mb-lg-0">
