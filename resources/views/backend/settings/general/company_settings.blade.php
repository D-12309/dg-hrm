                            ...
                            <div class="card card-with-shadow border-0">
                                ...
                                <div class="px-primary py-primary">
                                    <div role="tablist" aria-orientation="vertical" class="nav flex-column nav-pills"><a
                                            ...
                                            class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 active"><span>{{
                                                _trans('settings.Company Config') }}</span>
                                            <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    <div role="tablist" aria-orientation="vertical" class="nav flex-column nav-pills"><a
                                            ...
                                            class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3"><span>{{
                                                _trans('settings.API Setup') }}</span>
                                            <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="feather feather-chevron-right">
                                    ...
                                    <div id="General" class="tab-pane active  ">
                                        <div class="d-flex justify-content-between">
                                            <h5
                                                ...
                                                {{ _trans('common.Company Settings') }}</h5>
                                                ...
                                                <form action="{{ route('company.settings.update') }}" method="post"
                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 col-form-label">
                                                                        {{ _trans('settings.Select Language') }} <span class="text-danger">*</span>
                                                                    </label>
                                                                    <div class="col-sm-4">
                                                                        <div>
                                                                            <select name="lang" id="language" class="form-control">
                                                                                ...
                                                                                $language)
                                                                                <option value="{{ $language->language->code }}" {{ @$data['configs']['lang']===$language->
                                                                        ...
                                                                        <div>
                                                                            <div class="radio-button-group">
                                                                                <div data-toggle="buttons"
                                                                                    ...
                                                                                    <label class="btn border"><input
                                                                                            type="radio" name="ip_check"
                                                                                            id="appSettings_ip_check-0"
                                                                                            value="1" {{
                                                                                            @$data['configs']['ip_check']==='1'
                                                                                            ? 'checked' :'' }}>
                                                                                        <span>{{
                                                    ...
                                                    <fieldset class="form-group">
                                                        <div class="row">
                                                                        ...
                                                                        <div>
                                                                            <div class="radio-button-group">
                                                                                <div data-toggle="buttons" class="btn-group btn-group-toggle">
                                                                                    ...
                                                                                    <label class="btn border"><input type="radio" name="multi_checkin"
                                                                                            id="appSettings_multi_checkin-0" value="1" {{ @$data['configs']['multi_checkin']==='1'
                                                                                            ? 'checked' :'' }}>
                                                                                        <span> {{
                                                                                            _trans('settings.Enable')
                                                                                            }}</span></label><label class="btn border"><input type="radio" name="multi_checkin"
                                                                                            id="appSettings_multi_checkin-1" value="0" {{ @$data['configs']['multi_checkin']==='0'
                                                                                            ? 'checked' :'' }}>
                                                                                        <span> {{
                                                                                            _trans('settings.Disable')
                                                                                            }}</span></label>
                                                            ...
                                                            {{-- @dd(App\Enums\AttendanceMethod::FACE_RECOGNITION) --}}
                                                            <div class="col-lg-12">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-3 col-form-label">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div>
                                                                            <select name="attendance_method" class="form-control">
                                                                                <option value="{{ App\Enums\AttendanceMethod::NORMAL }}" {{ @$data['configs']['attendance_method']==App\Enums\AttendanceMethod::NORMAL?'selected':'selected'  }}>{{ _trans('attendance.Normal') }}</option>
                                                                                <option value="{{ App\Enums\AttendanceMethod::FACE_RECOGNITION }}" 
                                                                                    ...
                                                                                    <span class="badge badge-info">({{ _trans('common.Pro') }})</span>

                                                                                </option>
                                                                                <option value="{{ App\Enums\AttendanceMethod::BARCODE }}" 
                                                                                    {{ @$data['configs']['attendance_method']==App\Enums\AttendanceMethod::BARCODE?'selected':''  }}>
                                                                                    {{ _trans('attendance.Barcode') }}
                                                                                    <span class="badge badge-info">({{ _trans('common.Pro') }})</span>
                                                                                </option>
