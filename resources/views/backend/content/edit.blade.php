                        ...
                        <form method="POST" action="{{ route('content.update', $data['show']->id) }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">{{ _trans('common.Content') }}<span class="text-danger">*</span></label>
                                            <textarea class="form-control en" name="content" rows="10">{{ $data['show']->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">{{ _trans('common.Meta Title') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">{{ _trans('common.Meta Description') }}<span class="text-danger">*</span></label>
                                            <textarea class="form-control en" name="meta_description" rows="10">{{ $data['show']->meta_description }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">{{ _trans('common.Keywords') }}<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="image" class="col-sm-2 col-form-label">{{ _trans('common.Meta Image') }}</label>
                                            <div class="col-sm-10">
                                                <div>
                                                    @php
                                                    ...
                                                    <div class="custom-image-upload-wrapper">
                                                        ...
                                                        <div class="input-area"><label id="upload-label"
                                                                ...
                                                                {{ _trans('common.Change Meta Image') }}
