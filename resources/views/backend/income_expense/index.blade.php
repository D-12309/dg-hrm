...
@section('title',  _trans('finance.Income/Expense List'))
@section('content')
                        ...
                        <div class="col-sm-12">
                            <div class="float-sm-right">
                                <a href="{{ route('income_expense.create') }}"
                                    class="btn btn-primary">{{ _trans('finance.Add Income-Expense') }}</a>
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 filter-btn-margin">
                                <div class="form-group mt-2">
                                    <button type="submit" class="btn btn-primary income_expense_table_form">{{_trans('finance.Filter')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <table id="table" class="table card-table table-vcenter datatable mb-0 w-100 income_expense_table">
                            <thead>
                                <tr>
                                    <th>{{ _trans('finance.SL') }}</th>
                                    <th>{{ _trans('finance.Date') }}</th>
                                    <th>{{ _trans('finance.User') }}</th>
                                    <th>{{ _trans('finance.Type') }}</th>
                                    <th>{{ _trans('finance.Category') }}</th>
                                    <th>{{ _trans('finance.Amount') }}</th>
                                    <th>{{ _trans('common.Action') }}</th>>{{ _trans('finance.Action') }}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
