                                   ...
                                   <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" >
                                                ...
                                                <option value="1" {{ @$data['show'] ? $data['show']->status_id==1?'selected' : '':'' }}>{{ _trans('common.Active') }}</option>
                                                <option value="4" {{ @$data['show'] ? $data['show']->status_id==4?'selected' : '':'' }}>{{ _trans('common.In-active') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-6">
