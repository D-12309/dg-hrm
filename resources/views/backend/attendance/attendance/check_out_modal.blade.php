            ...
            <div class="modal-body">
                <div class="row pb-4 text-align-center">
                    <div class="col-md-12">
                        ...
                        <input type="hidden" id="in_time" value="{{ @isAttendee()['in_time'] }}">
                        <div class="form-group">
                        ...
                        @if (@$data['reason'][0] == 'LE' && settings('multi_checkin') !=1)
                            <div class="form-group w-50 ml-auto mr-auto">
                                <label class="cus-label float-left">{{ _trans('common.Are You Leaving Early?') }}</label>
                        ...
                        <div class="form-group button-hold-container">
                            <button class="button-hold" id="button-hold">
                                <div>
                                    <svg class="progress checkout_switch" viewBox="0 0 32 32">
                        ...
                        <input type="hidden" id="working_hours" value="{{ _trans('attendance.Working Hours') }}">
