                                    ...
                                    <div class="col-md-12">
                                        <div class="float-right mb-3  text-right">
                                            @if (hasPermission('attendance_read'))
                                                <a href="{{ route('attendance.index') }}" class="btn btn-primary">{{ _trans('attendance.Attendance List') }}</a>
                                            @endif
                                        </div>
                                    </div><!-- /.col -->
                                </div><!-- /.row -->
                                ...
                                <form action="{{ route('attendance.store') }}" enctype="multipart/form-data" method="post"
                                    ...
                                    <div class="row">
                                        @if (auth()->user()->role->name == 'Staff')
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="" class="cus-label">{{ _trans('common.Select Employee') }}</label>
                                        ...
                                        @else
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="" class="cus-label">{{ _trans('common.Select Employees') }}</label>
                                    ...
                                    <div class="card-header">
                                        <h5>{{ _trans('attendance.Check in') }}</h5>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('common.Time') }}</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('common.Location') }}</label>
                                                <input type="text" name="check_in_location" class="form-control"
                                                    placeholder="{{ _trans('attendance.Check in location') }}" value="{{ old('check_in_location') }}"
                                                    required>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>{{ _trans('attendance.Late in reason') }}</label>
                                                <textarea type="text" name="reason" class="form-control" placeholder="{{ _trans('attendance.Check in reason') }}">{{ old('reason') }}</textarea>
                                    ...
                                    <div class="card-header">
                                        <h5>{{ _trans('attendance.Check out') }}</h5>
                                    </div>
                                    <div class="row">

                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>{{ _trans('common.Time') }}</label>
                                                <div class="input-group clockpicker">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>{{ _trans('common.Location') }}</label>
                                                <input type="text" name="check_out_location" class="form-control"
                                                    placeholder="{{ _trans('attendance.Check out location') }}"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>{{ _trans('attendance.Early leave reason') }}</label>
                                                <textarea type="text" name="early_leave_reason" class="form-control" placeholder="{{ _trans('attendance.Check out reason') }}">{{ old('early_leave_reason') }}</textarea>
