                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('attendance.update',$data['show']->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('attendance.In Time') }}</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="check_in_location" class="form-control"
                                                       placeholder="{{ _trans('attendance.Check in location') }}"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>{{ _trans('attendance.Late reason') }}</label>
                                                <textarea type="text" name="late_in_reason" class="form-control"
                                                       placeholder="{{ _trans('attendance.Check in reason') }}">{{ @$data['show']->lateInReason->reason }}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('attendance.out time') }}</label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="early_leave_reason" class="form-control"
                                                       placeholder="{{ _trans('attendance.Check out reason') }}">{{ @$data['show']->earlyOutReason->reason }}</textarea>
