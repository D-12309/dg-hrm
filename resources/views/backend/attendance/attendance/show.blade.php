                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 text-capitalize">{{ _trans('common.Employee Name') }}</label>
                                                            <div class="col-sm-9">
                                                                <img class="employee-avater-img" src="{{ uploaded_asset($data['show']->avatar_id) }}"
                                                                    alt="" height="50" width="50"> {{ $data['show']->name }}
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="form-group row">
