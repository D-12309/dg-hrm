                            ...
                            <div class="card-body">
                                <form action="{{ route('attendance.store') }}" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('attendance.Check in location') }}</label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('attendance.Check In') }}</label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating">
                                                <label for="floatingTextarea2 cus-label">{{ _trans('attendance.Late Reason') }}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('attendance.Check Out location') }}</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label for="" class="cus-label">{{ _trans('attendance.Check out Time') }}</label>
