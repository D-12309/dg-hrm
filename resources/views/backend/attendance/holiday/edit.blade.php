                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-20">
                                    <form action="{{ route('holidaySetup.update',$data['holiday']->id) }}"
                                          ...
                                          method="post" id="holidayEditModal">
                                        @csrf
                                        @method('PATCH')
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" class="form-control"
                                                           value="{{ $data['holiday']->title }}" placeholder="{{ _trans('common.Title') }}"
                                                           required>
                                                    @if ($errors->has('title'))
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="start_date" id="start_date"
                                                           ...
                                                           class="form-control" placeholder="{{ _trans('common.Start Date') }}" required>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="end_date" id="end_date"
                                                           class="form-control" value="{{ $data['holiday']->end_date }}"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" id="description" class="form-control"
                                                              cols="30" rows="5" placeholder="{{ _trans('common.Description') }}"
                                                              required>{!! $data['holiday']->description !!}</textarea>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="status_id" class="form-control select2" required="required">
                                                        ...
                                                        <option value="1" {{ $data['holiday']->status_id ==1? 'selected':'' }}>
                                                            {{ _trans('common.Active') }}
                                                        </option>
                                                        <option value="2" {{ $data['holiday']->status_id ==2? 'selected':'' }}>
