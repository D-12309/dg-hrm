            ...
            <div class="modal-content">
                <div class="tab-content px-primary">
                    ...
                    <div class="content py-primary">
                        <form action="" enctype="multipart/form-data" method="post" id="paymentModal">
                            @csrf
                            <div class="row">
                                <label class="col-sm-3 col-form-label">{{ _trans('common.Amount') }}</label>
                                <div class="col-sm-9">
                                    <div><input type="text" name="amount" id="amount" required="required"
                                            placeholder="Amount" autocomplete="off" readonly class="form-control">
                                    </div>
                                    @if ($errors->has('amount'))
                                        <div class="error">{{ $errors->first('amount') }}</div>
                                    @endif
                                </div>
                                <label class="col-sm-3 col-form-label mt-3 mb-5">{{ _trans('common.Payment Method') }}</label>
