                    ...
                    <div class="">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <div class="form-group">
                                        <label for="image">{{_translate('Profile Picture')}}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{_translate('Name')}}</label>
                                        <input type="text" name="name" class="form-control" id="name"
                                            placeholder="{{_translate('Name')}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="phone">{{_translate('Phone')}}</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="email">{{_translate('Email')}}</label>
                                        <input type="email" class="form-control"
                                            value="{{ @$data['edit']->email ? $data['edit']->email : old('email') }}"
                                            name="email" id="email" placeholder="{{_translate('Email')}}">
                                        @if ($errors->has('email'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="permanent_address">{{_translate('Permanent Address')}}</label>
                                        <input class="form-control" id="permanent_address" name="permanent_address"
                                            placeholder="{{_translate('Permanent Address')}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="current_address">{{_translate('Current Address')}}</label>
                                        <input class="form-control " id="current_address" name="current_address"
                                            placeholder="{{_translate('Current Address')}}"
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary mb-3">{{_translate('Submit')}}</button>
                            </div>
                            {{Form::close()}}
                        </div>
                        <!-- /.card-body -->
