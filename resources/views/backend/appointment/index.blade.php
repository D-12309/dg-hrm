                        ...
                        @if(auth()->user()->id==$data['id'])
                                <div class="form-group mb-2">
                                    <a href="{{ route('appointment.create') }}"
                                       class="btn btn-primary ">{{ _trans('appointment.Add Appointment') }}</a>
                                </div>
                        @endif
                    </div>
                    {{-- </form> --}}
                    ...
                    <div class="col-lg-12">
                        <table id="table"
                            ...
                            <tr>
                                ...
                                <th>{{ _trans('appointment.Appointment With') }}</th>
                                <th>{{ _trans('common.Date') }}</th>
                                <th>{{ _trans('appointment.Start At') }}</th>
                                <th>{{ _trans('appointment.End At') }}</th>
