            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('appointment.update') }}" class="card"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="text" hidden value="{{ auth()->id() }}" name="user_id">
                            <input type="text" hidden value="{{ @$data['show']->id }}" name="id">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control"
                                                placeholder="{{ _translate('Enter Title') }}" value="{{ @$data['show']->title }}"
                                                required>
                                            @if ($errors->has('title'))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" placeholder="Enter Description" rows="6" required>{{ @$data['show']->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="date" class="cus-label">{{ _trans('appointment.Date Schedule') }}</label>
                                            <input type="date" name="date" id="date" class="form-control" value="{{ @$data['show']->date }}" placeholder="Date" required>
                                            @if ($errors->has('date'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ _trans('appointment.Appointment With') }}</label>
                                            <select name="appoinment_with" class="form-control select2" id="user_id">
                                                <option value="{{ @$data['show']->appoinment_with }}">{{ @$data['show']->otherParticipant->participantInfo->name }} </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="" class="cus-label">{{ _trans('appointment.Start Time') }}</label>
                                            <input type="time" class="form-control" name="appoinment_start_at"
                                                value="{{ @$data['show']->appoinment_start_at }}" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="" class="cus-label">{{ _trans('appointment.End Time') }}</label>
                                            <input type="time" class="form-control" name="appoinment_end_at"
                                                value="{{ @$data['show']->appoinment_end_at }}" required>
                                            ...
                                            <div>
                                                <div class="custom-image-upload-wrapper">
                                                    <div class="image-area d-flex">
                                                        <img id="bruh" src="{{ uploaded_asset(@$data['show']->visitImages->file_id) }}" alt=""
