...
@section('content')
                    ...
                    <div class="col-sm-6 d-flex">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mr-2 mb-2">
                                ...
                                <a href="{{ route('attendance.check-in') }}" class="btn btn-primary">{{ _trans('attendance.Add attendance') }}</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <table id="table"
                            ...
                            <tr>
                                ...
                                <th>{{ _trans('attendance.Break Count') }}</th>
    ...
    <input type="hidden" name="" id="attendance_report_data_url" value="{{  route('staff.authUserTable','attendance') }}">
    <input type="hidden" name="" id="__user_id" value="{{ auth()->user()->id }}">
