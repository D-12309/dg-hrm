                                ...
                                <div class="px-primary py-primary">
                                    <div role="tablist" aria-orientation="vertical"
                                        ...
                                        <a href="{{ route('staff.staffProfileEditView','official') }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','official') ? 'active' : '' }}"><span>{{ _trans('user.Official') }}</span>
                                        ...
                                        <a href="{{ route('staff.staffProfileEditView','personal') }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','personal') ? 'active' : '' }}"><span>{{ _trans('user.Personal') }}</span>
                                        ...
                                        <a href="{{ route('staff.staffProfileEditView','financial') }}"
                                           class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','financial') ? 'active' : '' }}"><span>{{ _trans('user.Financial') }}</span>
                                            <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                           width="24" height="24"
                                                                           viewBox="0 0 24 24" fill="none"
                                                                           stroke="currentColor" stroke-width="2"
                                            ...
                                            <a href="{{ route('staff.staffProfileEditView','emergency') }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','emergency') ? 'active' : '' }}"><span>{{ _trans('user.Emergency') }}</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                            ...
                                            <a href="{{ route('staff.staffProfileEditView','security') }}"
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','security') ? 'active' : '' }}"><span>{{ _trans('user.Security') }}</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                        ...
                                        @if(auth()->user()->is_admin==1)
                                            ...
                                            class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('staff.staffProfileEditView','company') ? 'active' : '' }}"><span>{{ _trans('user.Company') }}</span>
                                                <span class="active-icon"><svg
                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="2" stroke-linecap="round"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize cus-label">{{ _trans('common.Name') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize cus-label">{{ _trans('common.Email') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text" class="form-control"
                                                                                       name="email"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('common.Employee') }}
                                                                            id</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('common.Phone') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="text"
                                                                                       class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('common.Date of birth ') }}
                                                                            </label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                    ...
                                                    <form action="{{ route('user.update.profile',[$data['id'],$data['slug']]) }}"
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('user.TIN') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group row {{ !appSuperUser() ?'disabledbutton':'' }}">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('common.Salary') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <input type="number"
                                                                                       class="form-control"
                                            ...
                                            <div class="content py-primary">
                                                <div id="General-0">
                                                    ...
                                                    @if(settings('login_method')=='pin')
                                                        <fieldset>
                                                            <form action="{{ route('updateUserPin') }}" method="post">
                                                                @csrf
                                                                <div class="form-group row">
                                                                    <label for="pin" class="col-sm-2 col-form-label">{{ _trans('user.PIN') }} <span class="text-danger">*</span></label>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" required class="form-control" id="pin" name="pin" value="{{auth()->user()->pin}}">
                                                                        <small class="text-danger __pin"></small>
                                                                        {{-- error message --}}
                                                                        @if ($errors->has('pin'))
                                                                            <small class="error">{{ $errors->first('pin') }}</small>
                                                                        @endif
                                                                    </div>
                                                                <div class="col-sm-2">
                                                                        <button type="submit" class="btn btn-primary float-right">
