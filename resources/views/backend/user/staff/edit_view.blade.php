                                          ...
                                          <div class="col-md-12">
                                              <div class="form-group">
                                                  ...
                                                  <select name="gender" required
                                                      ...
                                                      <option value="Male" {{ $data['show']->gender == 'Male'?'selected':''}}>{{ _trans('user.Male')}}</option>
                                                      <option value="Female" {{ $data['show']->gender == 'Female'?'selected':''}}>{{_trans('user.Female')}}</option>
                                                      <option value="Unisex" {{ $data['show']->gender =='Unisex'?'selected':''}}>{{_trans('user.Unisex')}}</option>
                                                  </select>
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-md-12">
                                              <div class="form-group">
                                                  ...
                                                  <select name="marital_status" id="religion" class="form-control">
                                                      <option disabled selected>{{ _trans('common.Choose One') }}</option>
                                                      <option value="Married" {{ $data['show']->marital_status == 'Married'?'selected':''}}>{{_trans('user.Married')}}</option>
                                                      <option value="Unmarried" {{ $data['show']->marital_status == 'Unmarried'?'selected':''}}>{{_trans('user.Unmarried')}}</option>
                                                  </select>
