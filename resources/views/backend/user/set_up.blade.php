                                ...
                                @if (url()->current() === route('hrm.payroll_setup.user_setup', [$data['id'], 'contract']))
                                    <div class="d-flex justify-content-between pb-3">
                                        <h5 class="d-flex align-items-center text-capitalize mb-0 title">
                                            ...
                                            <span class="pl-2">{{ _trans('user.Set Contract') }} </span>
                                        </h5>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="date" class="form-control date"
                                                                                ...
                                                                                placeholder="{{ _trans('common.Contract End') }}"
                                ...
                                @if (url()->current() === route('hrm.payroll_setup.user_setup', [$data['id'], 'commissions']))
                                    <div class="d-flex justify-content-between pb-3">
                                        <h5 class="d-flex align-items-center text-capitalize mb-0 title">
                                            ...
                                            <span class="pl-2">{{ _trans('user.Set Commission') }} </span>
                                        </h5>
                                    ...
                                    <div class="d-flex justify-content-between pb-3">
                                        <h5 class="d-flex align-items-center text-capitalize mb-0 title">
                                            <span class="pl-2">{{ _trans('user.Addition') }} </span>
                                        </h5>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @else
                                                                <tr class="text-center">
                                                                    <td colspan="4">{{ _trans('user.No Data') }}</td>
                                                                </tr>
                                                            @endif
                                                        </tbody>
                                                    </table>
                                    ...
                                    <div class="d-flex justify-content-between pb-3">
                                        <h5 class="d-flex align-items-center text-capitalize mb-0 title">
                                            <span class="pl-2">{{ _trans('user.Deduction') }} </span>
                                        </h5>
                                        <button class="btn btn-primary float-right"
