                            ...
                            <form method="POST" action="{{ route('user.store') }}" class="card" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="marital_status" id="religion" class="form-control">
                                                    ...
                                                    <option value="Common-Law/Live-In" {{ old('marital_status')=='Common-Law/Live-In' ?'selected':''}}>
                                                        {{_trans('common.Common-Law/Live-In')}}
                                                    </option>
                                                    <option value="Widowed" {{ old('marital_status')=='Widowed' ?'selected':''}}>{{_trans('common.Widowed')}}
                                                    </option>
                                                    <option value="Separated" {{ old('marital_status')=='Separated' ?'selected':''}}>{{_trans('common.Separated')}}
                                                    </option>
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="name" class="cus-label">{{ _trans('common.Basic Salary') }}</label>
                                                <input type="number"
                                                       name="basic_salary"
                                        ...
                                        <div class="card-inner ">
                                            <table class="table table-striped role-create-table role-permission "
                                                ...
                                                @foreach($data['permissions'] as $permission)
                                                    <tr>
                                                        <td>
                                                            <span class="text-capitalize">{{ucfirst(str_replace('_',' ',_trans($permission->attribute)))}}</span>
                                                        </td>
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    @if($keyword != "")
                                                                        ...
                                                                        <label class="custom-control-label"
                                                                               for="{{$keyword}}">{{ucfirst(str_replace('_',' ',_trans($key)))}}</label>
                                                                    @endif
                                                                </div>
                                                            @endforeach
