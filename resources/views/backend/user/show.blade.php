                                    ...
                                    <div class="px-primary py-primary">
                                        <div role="tablist" aria-orientation="vertical"
                                            ...
                                            <a href="{{ route('user.profile', [$data['id'], 'official']) }}"
                                               class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'official']) ? 'active' : '' }}"><span>{{ _trans('common.Official') }}</span>
                                            ...
                                            <a href="{{ route('user.profile', [$data['id'], 'personal']) }}"
                                               class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'personal']) ? 'active' : '' }}"><span>{{ _trans('common.Personal') }}</span>
                                                <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                               width="24"
                                                                               height="24" viewBox="0 0 24 24"
                                                                               fill="none" stroke="currentColor"
                                            ...
                                            @if(auth()->user()->role_id != 1)
                                                ...
                                                class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 {{ url()->current() === route('user.profile', [$data['id'], 'financial']) ? 'active' : '' }}"><span>{{ _trans('common.Financial') }}</span>
                                                    <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                width="24"
                                                                                height="24" viewBox="0 0 24 24"
                                                                                fill="none" stroke="currentColor"
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label
                                                                                class="col-sm-3 col-form-label text-capitalize">{{ _trans('common.Joining
                                                                            date') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label
                                                                                class="col-sm-3 col-form-label text-capitalize">{{ _trans('common.Employee
                                                                            type') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
