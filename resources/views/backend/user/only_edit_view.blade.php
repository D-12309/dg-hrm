                                          ...
                                          <div class="col-md-12">
                                              <div class="form-group">
                                                  ...
                                                  <select name="marital_status" id="religion" class="form-control">
                                                      ...
                                                      <option value="Married" {{ $data['show']->marital_status == 'Married'?'selected':''}}>{{_trans('common.Married')}}</option>
                                                      <option value="Unmarried" {{ $data['show']->marital_status == 'Unmarried'?'selected':''}}>{{_trans('common.Unmarried')}}</option>
                                          ...
                                          @if(settings('login_method')=='pin')
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="pin" minlength="4" maxlength="6" required name="pin" placeholder="{{ _trans('common.PIN') }}" autocomplete="off" class="form-control"
                                                        value="{{ @$data['show']->pin }}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                                    @if ($errors->has('pin'))
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <select name="gender" required
                                                    ...
                                                    <option disabled selected>{{ _trans('common.Choose One') }}</option>
                                                    <option value="Male" {{ $data['show']->gender == 'Male'?'selected':''}}>{{_trans('common.Male')}}</option>
                                                    <option value="Female" {{ $data['show']->gender == 'Female'?'selected':''}}>{{_trans('common.Female')}}</option>
                                                    <option value="Unisex" {{ $data['show']->gender =='Unisex'?'selected':''}}>{{_trans('common.Unisex')}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mt-3">
