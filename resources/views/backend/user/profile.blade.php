                            ...
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active info-btn" href="#personal"
                                                            data-toggle="tab">{{ _trans('user.Personal Info') }}</a></li>
                                    <li class="nav-item"><a class="nav-link info-btn" href="#security"
                                                            data-toggle="tab">{{ _trans('user.Security Info') }}</a></li>
                                </ul>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="personal">
                                        <form class="form-horizontal" action="{{ route('admin.profile_update') }}"
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">{{ _trans('common.Date Of Birth') }}</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputEmail" class="col-sm-2 col-form-label">{{ _trans('common.Gender') }}</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="phone" class="col-sm-2 col-form-label">{{ _trans('common.Phone') }}</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                <label for="image" class="col-sm-2 col-form-label">{{ _trans('user.Profile Picture') }}</label>
                                                <div class="col-sm-10">
                                                    <div>
