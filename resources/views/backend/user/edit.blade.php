                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <select name="designation_id"
                                                                                        class="form-control">
                                                                                    <option value="" disabled>{{_trans('user.Choose One')}}
                                                                                    </option>
                                                                    ...
                                                                    <div class="form-group row {{ !appSuperUser() ?'disabledbutton':'' }}">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{_trans('user.Joining date')}}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                            ...
                                                                            <div>
                                                                                <select name="employee_type"
                                                                                    ...
                                                                                    @foreach(config('hrm.employee_type') as $item)
                                                                                        <option value="{{ $item }}" {{ $data['show']->original['data']['employee_type'] == $item ? 'selected' :'' }}>{{ _trans('settings.'.$item) }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{_trans('user.Employee id')}}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('user.Manager') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label
                                                                            class="col-sm-3 col-form-label text-capitalize">{{ _trans('common.Free Location') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('user.Grade') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('user.NID Picture') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('user.Passport') }}</label>
                                                                        <div class="col-sm-7">
                                                                            <div>
                                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('user.Passport Picture') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <div class="custom-image-upload-wrapper">
                                                                                    <div class="image-area d-flex">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label text-capitalize">{{ _trans('user.Profile Picture') }}</label>
                                                                        <div class="col-sm-9">
                                                                            <div>
                                                                                <div class="custom-image-upload-wrapper">
                                                                                    <div class="image-area d-flex">
                                                        ...
                                                        <fieldset class="form-group mb-5">
                                                            <div class="form-group row d-none">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <small class="text-danger _transold_password"></small>
                                                                     {{-- error message --}}
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <small class="text-danger _transpassword"></small>
                                                                    {{-- error message --}}
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <small class="text-danger _transpassword_confirmation"></small>
                                                                    {{-- error message --}}
                                                    ...
                                                    @if(settings('login_method')=='pin')
                                                        <fieldset>
                                                            <form action="{{ route('updateUserPin') }}" method="post">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="pin" class="col-sm-2 col-form-label">{{ _trans('common.PIN') }} <span class="text-danger">*</span></label>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" required class="form-control" id="pin" name="pin" value="{{@$data['show']->original['data']['pin'] }}">
                                                                        <small class="text-danger _transpin"></small>
                                                                        @if ($errors->has('pin'))
