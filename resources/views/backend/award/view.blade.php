                                                            ...
                                                            <table class="table project-overview-table">
                                                                <tbody>
                                                                    <div class="project-overview-id">
                                                                        <div class="mb-2">
                                                                            <img class="img-responsive" style="max-width: 100%" src="{{ uploaded_asset($data['view']->attachment) }}" alt="">
                                                                        </div>
                                                                    </div>
                                                                </tbody>
                                                            </table>
                                            ...
                                            <div class="col-md-4 project-overview-right">
                                                <table class="table project-overview-table">
                                                    <tbody>
                                                        ...
                                                        <tr class="project-overview-deadline">
                                                            <td class="bold">{{ _trans('common.Attachment') }}
                                                            </td>
                                                            <td>
                                                                <a href="{{ uploaded_asset($data['view']->attachment) }}" download>{{ _trans('common.Download') }}</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
