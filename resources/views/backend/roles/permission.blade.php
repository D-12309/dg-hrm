                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ _trans('settings.Permission Lists') }}</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="row">
                  ...
                  data-target="#add_permission"><i class="fas fa-plus"></i> {{_translate('Add Permission')}}</button> --}}
                            ...
                            {{ Form::model($data['role'], ['route' => ['roles.update', $data['role']->id], 'method' => 'post']) }}
                            <div class="card-body">
                                <!-- Minimal style -->
                                <div class="row">
                                ...
                                <div class="card-footer">
                                    <div class="d-flex">
                                        <button type="submit"
                                            class="btn  btn-primary ml-auto">{{ _trans('common.Submit') }}</button>
                                    </div>
                                </div>
                            </div>
                            {{ Form::close() }}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal_title">{{ _translate('Add Permission') }}</h5>
                ...
                {{ Form::model($data['role'], ['route' => ['permissions.store', $data['role']->id], 'method' => 'post']) }}
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn  btn-primary ml-auto">{{ _translate('Submit') }}</button>
                </div>
                {{ Form::close() }}
            </div>
        </div>
