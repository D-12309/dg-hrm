                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="user_id" class="form-control" id="custom_user" required>
                                    <option value="{{ @$data['edit']->user_id }}"> {{ @$data['edit']->user->name }}
                                    </option>
                                </select>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="remarks" rows="5" required>{!! @$data['edit']->remarks !!}</textarea>
                            </div>
                        </div>
                                ...
                                <div class="col-6">
                                    <fieldset id="demo1" class="rating">
                                        <input type="radio" {{ @$rate[0]['rating'] == 5 ? ' checked' : '' }}
                                            id="star5_{{ $competences->id }}" name="rating[{{ $competences->id }}]"
                                            value="5" />
                                        <label class="full" for="star5_{{ $competences->id }}"
                                            title="Awesome - 5 stars"></label>
                                        <input type="radio" {{ @$rate[0]['rating'] == 4.5 ? ' checked' : '' }}
                                        ...
                                        <input type="radio" {{ @$rate[0]['rating'] == 4 ? ' checked' : '' }}
                                            id="star4_{{ $competences->id }}" name="rating[{{ $competences->id }}]"
                                            value="4" />
                                        <label class="full" for="star4_{{ $competences->id }}"
                                            title="Pretty good - 4 stars"></label>
                                        <input type="radio" {{ @$rate[0]['rating'] == 3.5 ? ' checked' : '' }}
                                        ...
                                        <input type="radio" {{ @$rate[0]['rating'] == 3 ? ' checked' : '' }}
                                            id="star3_{{ $competences->id }}" name="rating[{{ $competences->id }}]"
                                            value="3" />
                                        <label class="full" for="star3_{{ $competences->id }}"
                                            title="Meh - 3 stars"></label>
                                        <input type="radio" {{ @$rate[0]['rating'] == 2.5 ? ' checked' : '' }}
                                        ...
                                        <input type="radio" {{ @$rate[0]['rating'] == 2 ? ' checked' : '' }}
                                            id="star2_{{ $competences->id }}" name="rating[{{ $competences->id }}]"
                                            value="2" />
                                        <label class="full" for="star2_{{ $competences->id }}"
                                            title="Kinda bad - 2 stars"></label>
                                        <input type="radio" {{ @$rate[0]['rating'] == 1.5 ? ' checked' : '' }}
                                        ...
                                        <input type="radio" {{ @$rate[0]['rating'] == 1 ? ' checked' : '' }}
                                            id="star1_{{ $competences->id }}" name="rating[{{ $competences->id }}]"
                                            value="1" />
