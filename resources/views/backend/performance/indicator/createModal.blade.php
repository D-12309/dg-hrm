            ...
            <div class="modal-body">
                <form action="{{ $data['url'] }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="designation_id" class="cus-label">{{ _trans('common.Designation') }}</label>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="shift_id" class="cus-label">{{ _trans('common.Shift') }}</label>
                    ...
                    <fieldset>
                        <legend>
                            <label for="">{{ _trans('common.Select') }} {{ _trans('performance.Competence') }} <span class="text-danger">*</span> 
                            <a href="{{ route('performance.competence.type.index') }}">{{ _trans('common.Add') }}</a>
                            </label>
                        </legend>
                        <div class="row">
                            @foreach ($data['competence_types'] as $competence_type)
                                ...
                                {{-- @dd($competence_type->competencies) --}}
