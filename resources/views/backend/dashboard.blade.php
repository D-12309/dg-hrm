...
@section('content')
            ...
            <div class="row mb-20 padding-right-custom">
                <div class="row col-12 padding-right-custom">
                    <div class="col-12 col-md-8 col-lg-8 col-lg-8 welcome_title">
                        <h3>{{ _trans('response.Welcome to') }} {{ config('settings.app.company_name') }},{{ Auth::user()->name }}</h3>
                    </div>
                    {{-- dropdown menu --}}
                    <div class="col-12 col-md-4 col-lg-4 col-lg-4 padding-right-custom">
                        ...
                        <div class="dropdown mr-2 float-left float-md-right float-lg-right float-xl-right">
                            <button class="btn btn-secondary filter-btn dropdown-toggle" type="button"
                                ...
                                <span id="__selected_dashboard">{{ _trans('common.Company Dashboard') }}</span>
    ...
    <input type="hidden" id="my_dashboard_txt" value="{{ _trans('common.My Dashboard') }}">
    <input type="hidden" id="superadmin_dashboard_txt" value="{{ _trans('common.Superadmin Dashboard') }}">
    <input type="hidden" id="company_dashboard_txt" value="{{ _trans('common.Company Dashboard') }}">
@endsection
@section('script')
