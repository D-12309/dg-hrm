                        ...
                        @if(hasPermission('role_read'))
                            <div>
                                <div class="row">
                                    <div class="col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <select name="department" class="form-control select2" id="department" onchange="department(this.value)">
                                                <option value="">{{ _trans('common.Choose Department') }}</option>
                                    ...
                                    <div class="col-xl-3">
                                        <label for="">{{ _trans('common.Choose Employee') }}</label>
                                        <div class="form-group">
                                ...
                                <div class="text-right">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary break_table_form">{{ _trans('common.Submit') }}</button>
                                    </div>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="col-lg-12">
                        <table id="table"
                            ...
                            <tr>
                                ...
                                <th>{{ _trans('common.Start') }}</th>
                                <th>{{ _trans('common.End') }}</th>
